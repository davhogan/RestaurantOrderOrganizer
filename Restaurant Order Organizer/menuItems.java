	...
	public static void main(String[] args) {
		...
		while (user_resp.equals("yes")) {
			...
			if (user_num == 1) {
				...
				while (user_resp.equals("yes")) {
					...
					System.out.println("[1] Big Mouths");
					System.out.println("[2] Super Torta");
					System.out.println("[3] Dragonwell Bistro");
					System.out.println("[4] Olive Garden");
					System.out.println("[5] Denny's");

					System.out.print("Enter number of restaurant to display menu and order from: ");
					user_num = input.nextInt();
					input.nextLine();

					//Big Mouth's chosen to order from
					if (user_num == 1) {
						user_num = 1;
						bigM.display(bm_head);
						//While the user wants to order from Big Mouth's
						while (user_resp.equals("yes")) {
							System.out.print("Enter the name of the item to add to the order from Big Mouths: ");
							item_name = input.nextLine();

							mn_temp = bigM.find_name(bm_head, item_name);
							...
							System.out.print("Would you like to order anyhing else from Big Mouths? (yes/no): ");
							user_resp = input.nextLine();
						}
						//Super Torta chosen to order from
					} else if (user_num == 2) {
						user_num = 1;
						superT.display(st_head);
						//While the user wants to order from Super Torta
						while (user_resp.equals("yes")) {
							System.out.print("Enter the name of the item to add to the order from Super Torta: ");
							item_name = input.nextLine();

							mn_temp = superT.find_name(st_head, item_name);
							//Item to order not in the menu
							if (mn_temp == null)
								System.out.println("Item not found in menu.");
							//Add the item to the order
							...
							System.out.print("Would you like to order anyhing else from Super Torta? (yes/no): ");
							user_resp= input.nextLine();
						}
						//Dragonwell Bistro chosen to order from
					} else if (user_num == 3) {
						user_num = 1;
						dragonB.display(db_head);
						//While the user wants to order from Dragonwell Bistro
						while (user_resp.equals("yes")) {
							System.out.print("Enter the name of the item to add to the order from Dragonwell Bistro: ");
							item_name = input.nextLine();

							mn_temp = dragonB.find_name(db_head, item_name);
							//Item to order not in the menu
							if (mn_temp == null)
								System.out.println("Item not found in menu.");
							//Add the item to the order
							...
							System.out.print("Would you like to order anyhing else from Dragonwell Bistro? (yes/no): ");
							user_resp = input.nextLine();
						}
						//Olive Garden chosen to order from
					} else if (user_num == 4) {
						user_num = 1;
						oliveG.display(og_head);
						//While the user wants to order from Olive Garden
						while (user_resp.equals("yes")) {
							System.out.print("Enter the name of the item to add to the order from Olive Garden: ");
							item_name = input.nextLine();

							mn_temp = oliveG.find_name(og_head, item_name);
							//Item to order not in the menu
							if (mn_temp == null)
								System.out.println("Item not found in menu.");
							//Add the item to the order
							...
							System.out.print("Would you like to order anyhing else from Olive Garden? (yes/no): ");
							user_resp = input.nextLine();
						}
					 //Dennys's chosen to order from
					} else if (user_num == 5) {
						user_num = 1;
						denny.display(den_head);
						//While the user wants to order from Denny's
						while (user_resp.equals("yes")) {
							System.out.print("Enter the name of the item to add to the order from Denny's: ");
							item_name = input.nextLine();

							mn_temp = denny.find_name(den_head, item_name);
							//Item to order not in the menu
							if (mn_temp == null)
								System.out.println("Item not found in menu.");
							//Add the item to the order
							...
							System.out.print("Would you like to order anyhing else from Denny's? (yes/no): ");
							user_resp = input.nextLine();
						}
					}
		...
		if (user_num == 3)
		{
			...
			if(o_head == null)
			   ...
			   ord_list.display_num(o_head,user_num);
		}
